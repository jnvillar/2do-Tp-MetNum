...
int main(int argc, char* argv[]){
	...
	if (argc != 8){
		printf("%s  [1 INPUT FILE] [2 CANTIDAD IMAGENES TRAIN INICIAL] [3 AUMTENTAR TRAIN EN] [4 ITERACIONES] [5 PSA: ALPHA] [6 PLS-DA: GAMMA] [7 OUTLIERS] \n", argv[0]);
		exit(1);
	}
